        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            {stats.map((stat) => (
              <div
                key={stat.id}
                className={`group bg-white dark:bg-slate-950/40 backdrop-blur-md border border-slate-100 dark:border-slate-900 rounded p-6 transition-all duration-300 flex items-center justify-between shadow-sm dark:shadow-lg ${stat.glowColor}`}
              >
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800/50 transition-all duration-500 group-hover:rotate-15 group-hover:bg-slate-100 dark:group-hover:bg-slate-950">
                  {stat.icon}
                </div>
              </div>
            ))}
