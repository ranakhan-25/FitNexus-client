      ...
      <div className="max-w-7xl mx-auto px-6 py-10 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Join FitNexus and discover expert-led fitness classes,
              connect with professional trainers, track your progress,
              and become part of a thriving fitness community.
            </motion.p>
            ...
            >
              <Link
                href="/classes"
                className="px-8 py-4 rounded-xl bg-green-500 text-white font-semibold hover:bg-green-600 transition shadow-lg"
              >
                Explore Classes
              </Link>
